...
- 2 layer neural network giving ccuracy for 5 classes
...
def main(args):
    ...
    a,b=mixup_data_refactor(_train_ds[0],to_categorical(_train_ds[1],num_classes=250), _train_ds_refactor[0],to_categorical(_train_ds_refactor[1],num_classes=250),alpha=0.6)
    ...
    _history = _dnn.fit(a,
                        ...
                        validation_data = (_val_ds[0],
                                           to_categorical(_val_ds[1], num_classes=250)),
